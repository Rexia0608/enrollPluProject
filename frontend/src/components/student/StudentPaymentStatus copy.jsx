  ...
  const submitPayment = async (data) => {
    ...
    try {
      ...
      if (data.promiseDate) {
        ...
        formData.append(
          "promiseNote",
          JSON.stringify({ promiseStatus: false }),
        );
      }
        ...
        >
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <p className="text-xs sm:text-sm text-gray-500">Tuition Fee</p>
              ...
              <div>
                <p className="text-xs sm:text-sm text-gray-500">Period Due</p>
