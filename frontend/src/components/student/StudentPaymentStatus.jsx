...
const StudentPaymentStatus = () => {
  ...
  // ✅ Fixed: Handle start enrollment navigation
  const handleStartEnrollment = useCallback(() => {
    navigate("/student/dashboard/enrollment"); // ✅ Fixed: Corrected spelling from "enrollement" to "enrollment"
  }, [navigate]);
  ...
  if (!state.enrollment)
    return (
      <NotEnrolledView user={user} onStartEnrollment={handleStartEnrollment} />
    );
